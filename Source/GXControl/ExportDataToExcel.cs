...
namespace GxControl
{
    public class ExportDataToExcel : IGxProcess 
    {
        ...
        private void formatGrid(GxGrid grid, DataTable tbl)
        {
            ...
            {
                if (!dicColumnWidth.ContainsKey(col.Key)) continue;
        ...
        public static void GetColumnInfo(out Dictionary<string, string> dicColumnText, out Dictionary<string, int> dicColumnWidth)
        {
            ...
            dicColumnText.Add("MaGiaDinhRieng", "Mã GĐ");
            ...
            dicColumnText.Add("QuanHe", "Quan Hệ");
            ...
            dicColumnText.Add("SoHonPhoi", "Số HP");
            dicColumnText.Add("NgayHonPhoi", "Ngày HP");
            dicColumnText.Add("NoiHonPhoi", "Nơi HP");
            dicColumnText.Add("CachThucHonPhoi", "Tình trạng HP");
            dicColumnText.Add("LinhMucChung", "Linh Mục Chứng");
            dicColumnText.Add("NguoiChung1", "Người Chứng 1");
            dicColumnText.Add("NguoiChung2", "Người Chứng 2");
