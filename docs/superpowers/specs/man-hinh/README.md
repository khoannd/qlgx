...
| In ấn và chứng nhận | `DBAccess/WordEngine.cs` + `ExcelReport/Report*.cs` (14 mô-đun) | ~140 + nhiều | xong (`in-an.md`) | 8/14 mẫu xong (Lý lịch cá nhân, Chứng nhận bí tích, Phiếu gia đình, Chứng nhận hôn phối, 4 mẫu Giấy giới thiệu); còn lại Rao hôn phối/Excel thật/biểu đồ chưa (xem `in-an.md` mục 8) |
