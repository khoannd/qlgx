...
| In ấn và chứng nhận | `DBAccess/WordEngine.cs` + `ExcelReport/Report*.cs` (14 mô-đun) | ~140 + nhiều | xong (`in-an.md`) | 8/14 mẫu + "In danh sách"/"In lý lịch cá nhân (gia đình)"/"In sổ gia đình" xong (xem `in-an.md` mục 5f); còn lại Rao hôn phối/Excel thật/biểu đồ chưa (xem `in-an.md` mục 8) |
